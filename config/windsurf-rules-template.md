...
```
# At session start
memory_search(query="recent work", tags="proj:myproject")
...
- Memories are shared across Claude Code, Codex, Windsurf, and other MCP-compatible sessions — same database
